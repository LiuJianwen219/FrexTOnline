...
from FrexTOnline.settings import Rabbit_MQ_IP, Rabbit_MQ_Port, Rabbit_MQ_VHOST
from FrexTOnline.settings import Rabbit_MQ_USER, Rabbit_MQ_PASS

from FrexTOnline.settings import Rabbit_MQ_QueueID_Compile
from FrexTOnline.settings import Compile_Server_Url, Compile_Server_Api
from FrexTOnline.settings import Compile_MAX_Thread
